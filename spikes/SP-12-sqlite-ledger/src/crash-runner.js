...
console.log(`======================================================================`);
console.log(`🚀 AUTOMATED CRASH INJECTION & RECOVERY SUITE (5 POINTS)`);
console.log(`======================================================================`);
...
for (let point = 1; point <= 5; point++) {
  ...
  if (proc.status !== 0) {
    console.error(`❌ Crash Point ${point} failed with exit code ${proc.status}`);
    process.exit(1);
  }
}
...
console.log(`\n======================================================================`);
console.log(`🎉 ALL 5 CRASH INJECTION TESTS & CARD PRIORITY TESTS PASSED!`);
console.log(`======================================================================\n`);
process.exit(0);
