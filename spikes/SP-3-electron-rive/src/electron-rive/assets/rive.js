...
g.hb.connect(g.Ra.destination)}).catch(function(l){console.log("Failed to get user media: "+l)});a==window.miniaudio.device_type.playback&&g.hb.connect(g.Ra.destination);g.Cc=f;return window.miniaudio.track_device(g)},246784:a=>window.miniaudio.get_device_by_index(a).Ra.sampleRate,246857:a=>{a=window.miniaudio.get_device_by_index(a);void 0!==a.hb&&(a.hb.onaudioprocess=function(){},a.hb.disconnect(),a.hb=void 0);void 0!==a.Ib&&(a.Ib.disconnect(),a.Ib=void 0);a.Ra.close();a.Ra=void 0;a.Cc=void 0},247257:a=>
{window.miniaudio.untrack_device_by_index(a)},247307:a=>{a=window.miniaudio.get_device_by_index(a);a.Ra.resume();a.state=window.miniaudio.device_state.started},247446:a=>{a=window.miniaudio.get_device_by_index(a);a.Ra.suspend();a.state=window.miniaudio.device_state.stopped}},lc,Jd,kc,Fd,Gd,Hd,Kd,Ld,Md,Nd,Ka,Rc,Pd={s:function(a,b,c){Xa=c;try{var d=Lb(a);switch(b){case 0:var e=Ya();if(0>e)break;for(;Ab[e];)e++;return Nb(d,e).fb;case 1:case 2:return 0;case 3:return d.flags;case 4:return e=Ya(),d.flags|=
